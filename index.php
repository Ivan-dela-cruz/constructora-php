<?php include 'header.php'; ?>
            ...
            <div class="sl-slider">
                ...
                <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25"
                    ...
                    <div class="sl-slide-inner">
                        ...
                        <h2><a href="#">2 habitaciones y 1 comedor en venta</a></h2>
                        <blockquote>
                            <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Quito, Ecuador</p>
                            <p>Hasta que no extienda el círculo de su compasión a todos los seres vivos, el hombre no
                                encontrará la paz.</p>
                            <cite style="background-color: #e0922e">$ 20,000,000</cite>
                        </blockquote>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-4">
                                <button class="btn btn-success" onclick="window.location.href='buysalerent.php'">Buscar
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
                        <p>Únete ahora y actualízate con todas las ofertas de propiedades.</p>
                        <button class="btn btn-info" data-toggle="modal" data-target="#loginpop">Iniciar sesión</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- banner -->
    <div class="container">
        <div class="properties-listing spacer"><a href="buysalerent.php" class="pull-right viewall">Ver todos los listados</a>
            ...
            <div id="owl-example" class="owl-carousel">
                <div class="properties">
                    ...
                    <h4><a href="property-detail.php">Urbanización San Felipe</a></h4>
                    <p class="price">Precio: $234,900</p>
                    <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom"
                                                      data-original-title="dormitorios">5</span> <span
                                data-toggle="tooltip" data-placement="bottom" data-original-title="sala">2</span>
                        <span data-toggle="tooltip" data-placement="bottom" data-original-title="parqueadero">2</span> <span
                                data-toggle="tooltip" data-placement="bottom" data-original-title="cocina">1</span>
                    </div>
                ...
                <div class="properties">
                    <div class="image-holder"><img src="images/properties/2.jpg" class="img-responsive"
                                                   alt="properties"/>
                        <div class="status new">Nueva</div>
                    </div>
                    <h4><a href="property-detail.php">Urbanización San Felipe</a></h4>
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-9 recent-view">
                    ...
                    <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested.
                        ...
                        Rackham.<br><a href="informacion.php">conozca más</a></p>
