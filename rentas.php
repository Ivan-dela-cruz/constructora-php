<?php include 'header.php'; ?>
    ...
    <div class="inside-banner">
        <div class="container">
            <span class="pull-right"><a href="index.php">Inicio</a> / Rentas</span>
            <h2> Rentar inmueble</h2>
        </div>
    </div>
    <!-- banner -->
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <select class="form-control">
                                    ...
                                    <option>dos pisos</option>
                                    <option>casa simple</option>
                                </select>
                            </div>
                            <div class="col-lg-7">
                                <select class="form-control">
                    ...
                    <div class="hot-properties hidden-xs">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-7">
                                <h5><a href="renta-detail.php">Inmueble nuevo con finos acabados</a></h5>
                ...
                <div class="col-lg-9 col-sm-8">
                    ...
                    <div class="row">
                        ...
                        $query = "SELECT * FROM renta WHERE estado='En renta'";
                        ...
                        <div class="col-lg-4 col-sm-6">
                           <div class="properties">
                                    ...
                                    <h4><a href="property-detail.php">' . $fila['titulo'] . '</a></h4>
                                     <p class="price">Mensualidad $' . $fila['preciom'] . '</p>
                                   ...
                                   <div class="listing-detail">
                                    ...
                                    <a class="btn btn-primary" href="renta-detail.php?id=' . $fila['id'] . '">Ver detalles</a>
                            </div>
                        </div>';
                        }
                        ?>
