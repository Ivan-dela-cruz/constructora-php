...
<div class="inside-banner">
    <div class="container">
        <span class="pull-right"><a href="#">Inicio</a> / Vender</span>
            ...
            <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 ">
                <div class="form-group">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        <form action="solicitud/guardarDatosVenta.php" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <hr>
                                <input class="form-control" type="hidden" name="idventa" value="' . $fila['id'] . '">
