...
$campos = "titulo='$titulo',direccion='$direccion',telefono='$telefono',preciom='$preciom',preciog='$preciog',detalle='$detalle',tipo='$tipo',dormitorio='$dormitorio',cocina='$cocina',banio='$banio',parqueadero='$parqueadero',estado='$estado'";

$query = "UPDATE renta SET $campos WHERE id='$id'";
if ($mysqli->query($query)) {
    if (($_FILES["file1"]["error"] > 0)) {
        ...
        $sentencia_img = "UPDATE renta SET file1='$ruta' WHERE id='$id' ";
    ...
    if (($_FILES["file2"]["error"] > 0)) {
        ...
        $sentencia_img = "UPDATE renta SET file2='$rut' WHERE id='$id' ";
        $mysqli->query($sentencia_img) or die ("Error al actualizar datos" . mysqli_error($mysqli));
    }
    if (($_FILES["file3"]["error"] > 0)) {
        ...
        $sentencia_img = "UPDATE renta SET file3='$ruta3' WHERE id='$id' ";
        $mysqli->query($sentencia_img) or die ("Error al actualizar datos" . mysqli_error($mysqli));
    ...
    if (($_FILES["file4"]["error"] > 0)) {
        ...
        $sentencia_img = "UPDATE renta SET file4='$ruta4' WHERE id='$id' ";
        $mysqli->query($sentencia_img) or die ("Error al actualizar datos" . mysqli_error($mysqli));
