        ...
        if ($_FILES["file2"]["error"] > 0) {
            ...
            if ($_FILES["file3"]["error"] > 0) {
                ...
                if ($_FILES["file4"]["error"] > 0) {
                    ...
                    $query = "INSERT INTO venta(titulo,direccion,file1,file2,file3,file4,telefono,precio,detalle,dormitorio,cocina,banio,parqueadero,estado) VALUES('$titulo','$direccion','$ruta','$ruta2','$ruta3','$ruta4','$telefono','$precio','$detalle','$dormitorio','$cocina','$banio','$parqueadero','$estado')";
